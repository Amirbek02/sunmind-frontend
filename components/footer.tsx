    ...
    <footer className="border-t bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Интеллектуальные светильники нового поколения для умного и
              экологичного освещения.
            </p>
          </div>
        ...
        <div className="mt-8 border-t pt-8 text-center text-sm text-gray-600 dark:text-gray-400">
          <p>
            © {new Date().getFullYear()} SunMind. Все права защищены.{' '}
            <Link
              href="/privacy"
